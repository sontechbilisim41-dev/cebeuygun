            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="border-gray-300 focus:border-orange-600"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="border-gray-300 focus:border-orange-600 pr-10"
                  />
                  <Button
                    type="button"
                    variant="ghost"
              ...
              <div className="flex items-center justify-between text-sm">
                <Link href="/courier/forgot-password" className="text-orange-600 hover:underline">
                  Şifremi Unuttum
                </Link>
              </div>
              ...
              <Button 
                ...
                disabled={isLoading}
              >
                {isLoading ? 'Giriş Yapılıyor...' : 'Kurye Paneline Giriş'}
              </Button>
            </form>
